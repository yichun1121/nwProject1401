 ...
 */
@protocol TripDetailCDTVCDelegate
- (void)theSaveButtonOnTheTripDetailCDTVCWasTapped:(TripDetailCDTVC *)controller; //上面要加@class AddTripTVC;才可以用
@end


@interface TripDetailCDTVC : UITableViewController

@property (weak, nonatomic) IBOutlet UITextField *tripName; //TODO: tripName不知道要weak還是strong
@property (nonatomic, weak) id <TripDetailCDTVCDelegate> delegate;
